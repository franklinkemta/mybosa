<form method="POST" action="{{ $current_section['action'] }}">
    ...
    <div class="card-body mt-2">
        ...
        <hr>
        <div class="form-group row">
            <label for="nom_prenom_tuteur" class="col-sm-4 col-form-label">  <b>Nom et Prénom du tuteur:</b></label>
            <div class="col-sm-8">
        ...
        <div class="form-group row">
            <label for="profession_tuteur" class="col-sm-3 col-form-label">  <b>Proféssion du tuteur:</b></label>
            <div class="col-sm-4">
            ...
            <label for="telephone_tuteur" class="col-sm-1 col-form-label"><b>Tel:</b></label>
            <div class="col-sm-4">
        ...
        <div class="form-group row">
            <label for="parente_tuteur" class="col-sm-4 col-form-label">  <b>Lien de parneté:</b></label>
            <div class="col-sm-8">
