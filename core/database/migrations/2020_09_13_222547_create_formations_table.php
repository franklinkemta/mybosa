...
class CreateFormationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('formations', function (Blueprint $table) {
            ...
            $table->string('etablissement_intitule_filiere')->nullable(); // the name of that filiere for this particular school
            $table->string('etablissement_specialite')->nullable();
